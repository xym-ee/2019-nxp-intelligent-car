...
/* oled.c 中用到的宏定义 */
#define LCD_DC(n)   GPIO_PinWrite(LCD_DC_GPIO,LCD_DC_PIN,n)     //E11
#define LCD_RST(n)	GPIO_PinWrite(LCD_RST_GPIO,LCD_RST_PIN,n)   //E12
#define LCD_SDA(n)	GPIO_PinWrite(LCD_SDA_GPIO,LCD_SDA_PIN,n)   //D12
#define LCD_SCL(n)  GPIO_PinWrite(LCD_SCL_GPIO,LCD_SCL_PIN,n)   //D11
